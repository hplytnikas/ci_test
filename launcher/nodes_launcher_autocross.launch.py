...
def generate_launch_description():
    ...
    controller_mode_arg = DeclareLaunchArgument(
        ...
        description="Mode to launch: mpc_safe, mpc_risky, mpc_rain, pure_pursuit",
    )
    ...
    autocross_handler_pkg_share_dir = get_package_share_directory("autocross_handler")
    ...
    slam_launch = os.path.join(
        slam_pkg_share_dir, "launch", "slam_frontend_autocross.launch.py"
    )
    ...
    autocross_handler_launch = os.path.join(
        autocross_handler_pkg_share_dir, "launch", "autocross_handler.launch.py"
    )
    ...
    def generate_common_launch_description(perception_mode, controller_mode):
        ...
        common_launch_description = [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(autocross_handler_launch)
            ),
            IncludeLaunchDescription(
