...
def generate_launch_description():
    ...
    skidpad_handler_pkg_share_dir = get_package_share_directory("skidpad_handler")
    ...
    slam_launch = os.path.join(
        slam_pkg_share_dir, "launch", "slam_frontend_skidpad.launch.py"
    )
    ...
    lidar_cone_detector_launch = os.path.join(
        ...
        "launch",
        "lidar_cone_detector_skidpad.launch.py",
    )
    ...
    pure_pursuit_launch = os.path.join(
        ...
        "launch",
        "pure_pursuit_controller_skidpad.launch.py",
    )
    ...
    skidpad_handler_launch = os.path.join(
        skidpad_handler_pkg_share_dir, "launch", "skidpad_handler.launch.py"
    )
    ...
    def generate_common_launch_description(perception_mode):
        ...
        common_launch_description = [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(skidpad_handler_launch)
            ),
        ]
