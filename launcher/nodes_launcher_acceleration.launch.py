...
def generate_launch_description():
    ...
    path_planner_pkg_share_dir = get_package_share_directory(
        "acceleration_path_planner_basic"
    )
    ...
    acceleration_handler_pkg_share_dir = get_package_share_directory(
    ...
    # Path Planner Node launch file
    path_planner_launch = os.path.join(
        path_planner_pkg_share_dir, "launch", "acceleration_path_planner.launch.py"
    )
    # SLAM Node launch file
    slam_launch = os.path.join(
        slam_pkg_share_dir, "launch", "slam_frontend_acceleration.launch.py"
    )
    ...
    lidar_cone_detector_launch = os.path.join(
        ...
        "launch",
        "lidar_cone_detector_accelaration.launch.py",
    )
    ...
    pure_pursuit_launch = os.path.join(
        ...
        "launch",
        "pure_pursuit_controller_acceleration.launch.py",
    )
    ...
    acceleration_handler_launch = os.path.join(
        acceleration_handler_pkg_share_dir, "launch", "acceleration_handler.launch.py"
    )
    ...
    def generate_common_launch_description(perception_mode):
        common_launch_description = [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(acceleration_handler_launch)
            ),
        ]
