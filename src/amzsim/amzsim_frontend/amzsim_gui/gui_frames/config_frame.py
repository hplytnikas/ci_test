...
class ConfigFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, parent):
        ...
        self.frame_vehicle = None
        self.label_vehicle = None
        self.om_car = None
        self.checkbox_llc = None
        self.label_pge = None
        self.om_pge = None
        self.label_tv_exp = None
        self.entry_tv_exp = None
        self.label_tv_ff = None
        self.entry_tv_ff = None
        self.label_tv_p = None
        self.entry_tv_p = None
        self.label_tv_i = None
        self.entry_tv_i = None
        self.label_tv_d = None
        self.entry_tv_d = None
        self.label_ax_p = None
        self.entry_ax_p = None
        self.label_ax_i = None
        self.entry_ax_i = None
        self.label_ax_d = None
        self.entry_ax_d = None
        self.label_ax_m = None
        self.entry_ax_m = None
        self.label_ax_q = None
        self.entry_ax_q = None
        self.checkbox_roll = None
    ...
    def bind_buttons(self):
        ...
        # )
        # )
        self.om_car.configure(
            command=lambda x: self.config_frame_functions.adjust_vehicle_settings(
                self.om_car.get()
            )
        )
    ...
    def get_sim_config(self):
        ...
        sim_config_args = {
            ...
            "tv ff": self.entry_tv_ff.get(),
            "tv exp": self.entry_tv_exp.get(),
            "tv p": self.entry_tv_p.get(),
            "tv i": self.entry_tv_i.get(),
            "tv d": self.entry_tv_d.get(),
            "ax m": self.entry_ax_m.get(),
            "ax q": self.entry_ax_q.get(),
            "ax p": self.entry_ax_p.get(),
            "ax i": self.entry_ax_i.get(),
            "ax d": self.entry_ax_d.get(),
            "pge": self.om_pge.get(),
            "roll": self.checkbox_roll.get(),
        }
